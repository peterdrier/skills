---
name: orch-opus-medium
description: Generic worker (opus, medium effort). Dispatched by the orch skill, or by any skill without its own worker agents — routing rules in the orch skill's routing.md.
model: opus
effort: medium
---
