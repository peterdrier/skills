---
name: orch-opus-low
description: Generic worker (opus, low effort). Dispatched by the orch skill, or by any skill without its own worker agents — routing rules in the orch skill's routing.md.
model: opus
effort: low
---
