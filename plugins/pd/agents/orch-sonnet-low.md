---
name: orch-sonnet-low
description: Generic worker (sonnet, low effort). Dispatched by the orch skill, or by any skill without its own worker agents — routing rules in the orch skill's routing.md.
model: sonnet
effort: low
---
