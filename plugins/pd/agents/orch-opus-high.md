---
name: orch-opus-high
description: Generic worker (opus, high effort). Dispatched by the orch skill, or by any skill without its own worker agents — routing rules in the orch skill's routing.md.
model: opus
effort: high
---
