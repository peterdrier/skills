---
name: orch-sonnet-medium
description: Generic worker (sonnet, medium effort). Dispatched by the orch skill, or by any skill without its own worker agents — routing rules in the orch skill's routing.md.
model: sonnet
effort: medium
---
